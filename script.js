// Project Setup
const names = ["Alice", "Bob", "Carol", "Evan", "Simon", "Peter"];
const occupations = [
  "Writer",
  "Teacher",
  "Programmer",
...
function updateAverageStartingPrice() {
  ...
  averageElement.textContent = `Average Starting Price: $${averageStartingPrice.toFixed(
    2
  )}`;
...
// Interval to add new freelancer every 4 seconds (4000 milliseconds)
setInterval(addNewFreelancer, 4000);
